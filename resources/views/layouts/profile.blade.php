        ...
        <div class="sidebar">
            <div>
                ...
                <div class="text-center">
                    ...
                    <br>
                    <img src="{{ asset(auth()->user()->profile_photo_path ? 'storage/' . auth()->user()->profile_photo_path : 'assets/images/Bitmap.png') }}" alt="Profile Photo" width="65px" class="img-radius mt-5" id="navbarProfileImage">
                    <h4>{{ auth()->user()->name }}</h4>
                    <div class="line"></div>
                </div>
                <div class="mx-2">
                    <a href="{{ route('user-dashboard') }}" class="{{ request()->routeIs('user-dashboard') ? 'active' : '' }}">Dashboard</a>
                    <a href="{{ route('user-appointments') }}" class="{{ request()->routeIs('user-appointments') ? 'active' : '' }}">Appointments</a>
