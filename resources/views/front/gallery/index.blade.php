                ...
                <div class="card">
                    <div class="card-header mt-6">
                        ...
                        <div class="card-toolbar">
                            <!-- Add Category Button -->
                            <button type="button" class="btn btn-light-success me-3" data-bs-toggle="modal" data-bs-target="#modalCreateCategory">
                            ...
                            <!-- Add Image Button -->
                            <button type="button" class="btn btn-light-{{ primary_color() }}" data-bs-toggle="modal" data-bs-target="#modalCreateEdit">
                                <span class="svg-icon svg-icon-3">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.3" x="2" y="2" width="20" height="20" rx="5" fill="currentColor" />
                                        <rect x="10.8891" y="17.8033" width="12" height="2" rx="1" transform="rotate(-90 10.8891 17.8033)" fill="currentColor" />
                        ...
                        <div class="row">
                            ...
                            <div class="row mb-5 border">
                                <div class="col-12 d-flex align-center mb-5 border">
                                    ...
                                    <div class="ms-10">
                                        <button type="button" class="btn btn-icon btn-light btn-active-light-{{ primary_color() }} btn-sm edit-category mr-3" data-id="{{ $category->id }}">
                                            <i class="fa-solid fa-pen-to-square fs-6 fw-bold fw-bolder"></i>
                                        </button>
                                        <button type="button" class="btn btn-icon btn-light btn-active-light-{{ primary_color() }} btn-sm delete-category mr-3" data-id="{{ $category->id }}">
...
<div class="modal fade" id="modalCreateEdit" tabindex="-1" role="dialog" aria-labelledby="modalCreateEditLabel" aria-hidden="true">
