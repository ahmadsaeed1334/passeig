        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            <div id="kt_app_content_container" class="app-container container{{ general('layout') }}">
                <div class="card card-flush">
                    ...
                    <form action="{{ route('rev_slider.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group ms-3 me-3 mt-3">
                            ...
                            <textarea class="form-control" id="long_description" name="description" rows="5">{{ old('description') }}</textarea>
                        </div>
