                        ...
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative me-5 my-1">
                                ...
                                <input wire:model.debounce.500ms="search" type="text" data-kt-Users-table-filter="search"
                                    ...
                                    placeholder="Search {{ Str::singular($page_title ?? ' Our Passion') }} by id or name" />
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach($passions as $passion)
                                    <tr>
                                        ...
                                        <td>{{ \Illuminate\Support\Str::words(strip_tags($passion->long_description), 10, '...') }}</td>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('passions.destroy', $passion->id) }}" method="POST" style="display:inline-block;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" {!! confirm() !!} class="btn btn-sm btn-icon btn-light btn-active-light-{{ primary_color() }}" data-bs-placement="top" title="Delete {{ Str::singular('Our Passion ') }}" data-bs-toggle="tooltip">
