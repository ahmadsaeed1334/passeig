                ...
                <div class="card card-flush">
                    ...
                    <form action="{{ route('aboutus.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group ms-3 me-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="short_description" name="short_description" value="{{ old('short_description', $about->short_description) }}">
                        </div>
                        <div class="form-group ms-3 me-3 mt-3">
                            <div class="col-lg-4">
                                ...
                                <div class="image-input image-input-outline align-items-center" style="background-image: url({{ asset('img/bg-back.jpg') }}); background-size:100% 100%;width:300px">
                                    <div class="image-input-wrapper" id="image-preview" style="background-image: url({{ $about->image ? asset('storage/'.$about->image) : asset('img/bg-back.jpg') }}); background-size:100% 100%;width:300px">
                                    </div>
                        ...
                        <div class="form-group ms-3 me-3 mt-3">
                            ...
                            <textarea class="form-control" id="long_description" name="long_description" rows="5">{{ old('long_description', $about->long_description) }}</textarea>
                        </div>
