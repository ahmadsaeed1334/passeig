                                    ...
                                    <div class="dropdown-menu cart-dropdown-item-wraper">
                                        <div class="nav-cart-content">
                                            ...
                                            <div class="nav-cart-action p-a15 clearfix">
                                                <button class="site-button  btn-block m-b15 " type="button">View
                                                    Cart</button>
                ...
                <div id="rev_slider_149_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="snowaddon1" data-source="gallery" style="background-color:#2d3032;padding:0px;">
                    <div id="rev_slider_149_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                        <ul>
                            ...
                            color: rgba(255, 255, 255, 1.00); display: block;font-family:Poppins;">Dummy text is
                                                text that is used in the publishing.</div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="section-full p-t100  p-b70 bg-bottom-center bg-full-width bg-no-repeat" style="background-image:url(../images/background/bg-1.png);">
                    <div class="container ">
                        <div class="section-head text-center">
                            <h1><span class="site-text-primary"> Welcome to </span> Passeig center</h1>
                        ...
                        <div class="section-content text-center about-spa m-b30">
                            <p>
                                ...
                                centuries, but also the leap into electronic typesetting, remaining unchanged. It was
                                popularised in the 1960s with the release Ipsum is simply dummy text of the printing and
                                ...
                                <div class="col-lg-4 col-md-6 m-b30">
                                    <div class="wt-icon-box-wraper p-a30 center">
                                        ...
                                        <div class="icon-content">
                                            ...
                                            <p class="text-secondry">Lorem Ipsum is simply dummy text of the printing and
                            ...
                            <div>
                                <a href="shortcode-pricing-table.html" class="m-b15 site-button text-uppercase radius-sm m-lr15 font-weight-700 button-lg">See
                                    our Plans</a>
                                <a href="faq-1.html" class="m-b15 site-button-secondry text-uppercase radius-sm m-lr15 font-weight-700 button-lg">More
                                    Detail</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-4 col-md-12 m-b30">
                                    <div class="nav-item">
                                        <a class="nav-link active wt-icon-box-wraper right p-a10 m-b20" href="#tab1" data-bs-toggle="tab">
                                            <div class="icon-md site-text-primary radius">
                                                <span class="icon-cell  site-text-primary"><img src="{{ asset('assets/images/icon/candle-1.png')}}" alt=""></span>
                                            </div>
                                            <div class="icon-content">
                                    ...
                                    <div class="nav-item">
                                        <a class="nav-link wt-icon-box-wraper right p-a10 m-r30 m-b20" href="#tab2" data-bs-toggle="tab">
                                            <div class="icon-md site-text-primary radius">
                                                <span class="icon-cell  site-text-primary"><img src="{{ asset('assets/images/icon/leaves.png')}}" alt=""></span>
                                            </div>
                                            <div class="icon-content">
                                    ...
                                    <div class="nav-item">
                                        <a class="nav-link wt-icon-box-wraper right p-a10 m-b20" href="#tab3" data-bs-toggle="tab">
                                            <div class="icon-md site-text-primary radius">
                                                <span class="icon-cell  site-text-primary"><img src="{{ asset('assets/images/icon/lotus-position.png')}}" alt=""></span>
                                            </div>
                                            <div class="icon-content">
                                ...
                                <div class="col-lg-4 col-md-12 m-b30">
                                    <div class="circle-content-pic tab-content ">
                                        <div id="tab1" class="tab-pane in active">
                                            <div class="wt-box">
                                                <div class="wt-media site-text-primary m-b20 ">
                                                    <img src="{{ asset('assets/images/circle-block/1.jpg')}}" class="radius-bx" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="tab2" class="tab-pane">
                                            <div class="wt-box">
                                                <div class="wt-media site-text-primary m-b20">
                                                    <img src="{{ asset('assets/images/circle-block/2.jpg')}}" class="radius-bx" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="tab3" class="tab-pane">
                                            <div class="wt-box">
                                                <div class="wt-media site-text-primary m-b20">
                                                    <img src="{{ asset('assets/images/circle-block/3.jpg')}}" class="radius-bx" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="tab4" class="tab-pane">
                                            <div class="wt-box">
                                                <div class="wt-media site-text-primary m-b20">
                                                    <img src="{{ asset('assets/images/circle-block/4.jpg')}}" class="radius-bx" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="tab5" class="tab-pane">
                                            <div class="wt-box">
                                                <div class="wt-media site-text-primary m-b20">
                                                    <img src="{{ asset('assets/images/circle-block/5.jpg')}}" class="radius-bx" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="tab6" class="tab-pane">
                                            <div class="wt-box">
                                                <div class="wt-media site-text-primary m-b20">
                                                    <img src="{{ asset('assets/images/circle-block/6.jpg')}}" class="radius-bx" alt="">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-12 m-b30">
                                    <div class="nav-item">
                                        <a class="nav-link wt-icon-box-wraper left p-a10 m-b20" href="#tab4" data-bs-toggle="tab">
                                            <div class="icon-md site-text-primary radius">
                                                <span class="icon-cell  site-text-primary"><img src="{{ asset('assets/images/icon/bathtub.png')}}" alt=""></span>
                                            </div>
                                            <div class="icon-content">
                                    ...
                                    <div class="nav-item">
                                        <a class="nav-link wt-icon-box-wraper left p-a10 m-l30 m-b20" href="#tab5" data-bs-toggle="tab">
                                            <div class="icon-md site-text-primary radius">
                                                <span class="icon-cell  site-text-primary"><img src="{{ asset('assets/images/icon/jacuzzi.png')}}" alt=""></span>
                                            </div>
                                            <div class="icon-content">
                                    ...
                                    <div class="nav-item">
                                        <a class="nav-link wt-icon-box-wraper left p-a10 m-b20" href="#tab6" data-bs-toggle="tab">
                                            <div class="icon-md site-text-primary radius">
                                                <span class="icon-cell  site-text-primary"><img src="{{ asset('assets/images/icon/massage.png')}}" alt=""></span>
                                            </div>
                                            <div class="icon-content">
                                        ...
                                        <div class="wt-box">
                                            ...
                                            <div class="wt-info bg-white text-center bdr-5 bdr-primary">
                                                ...
                                                <div class="wt-info-text p-a30">
                                                    <h3>Back Massage</h3>
                                                    <p>Lorem Khaled Ipsum is a major key to success. Put it this way, it
                                                        took me twenty five years to get these plants.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="section-content">
                            <div class="row d-flex justify-content-center">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 m-b30">
                                    <div class="wt-box">
                                        <div class="wt-media site-text-primary m-b20 radius-bx circle-effect-1">
                                            <img src="{{ asset('assets/images/our-experts/ex1.jpg')}}" class="radius-bx" alt="">
                                        </div>
                                        <div class="wt-info p-t30 text-center">
                                            <h2>Camila</h2>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 m-b30">
                                    <div class="wt-box">
                                        <div class="wt-media site-text-primary m-b20 radius-bx circle-effect-1">
                                            <img src="{{ asset('assets/images/our-experts/ex2.jpg')}}" class="radius-bx" alt="">
                                        </div>
                                        <div class="wt-info p-t30 text-center">
                                            <h2>Milagros</h2>
                                            <p>Founder, Beauty Spa</p>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 m-b30">
                                    <div class="wt-box">
                                        <div class="wt-media site-text-primary m-b20 radius-bx circle-effect-1">
                                            <img src="{{ asset('assets/images/our-experts/ex3.jpg')}}" class="radius-bx" alt="">
                                        </div>
                                        <div class="wt-info p-t30 text-center">
                                            <h2>Agustina.</h2>
                                            <p>Founder, Beauty Spa</p>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 m-b30 m-b30">
                                    <div class="wt-box">
                                        ...
                                        <div class="wt-info p-t30 text-center">
                                            ...
                                            <a href="wish-list.html" class="site-button text-uppercase radius-sm font-weight-700 button-lg">Add
                                                to cart</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-12 m-b30">
                                    ...
                                    <div class="blog-post latest-blog-3 blog-md date-style-1 clearfix">
                                        <div class="wt-post-media wt-img-effect zoom-slow">
                                            <a href="blog-grid-2-sidebar.html"><img src="{{ asset('assets/images/blog/blog-small/pic1.jpg')}}" alt=""></a>
                                        </div>
                                    ...
                                    <div class="blog-post latest-blog-3 blog-md date-style-1 clearfix">
                                        <div class="wt-post-media wt-img-effect zoom-slow">
                                            <a href="blog-grid-2-sidebar.html"><img src="{{ asset('assets/images/blog/blog-small/pic2.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="wt-post-info">
                                            <div class="wt-post-title ">
                                    ...
                                    <div class="blog-post latest-blog-3 blog-md date-style-1 clearfix">
                                        <div class="wt-post-media wt-img-effect zoom-slow">
                                            <a href="blog-grid-2-sidebar.html"><img src="{{ asset('assets/images/blog/blog-small/pic3.jpg')}}" alt=""></a>
                                        </div>
                                        <div class="wt-post-info">
                                            <div class="wt-post-title ">
                        ...
                        <div class="section-content">
                            <div class="owl-carousel client-logo-carousel">
                                ...
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo1.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 2 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo2.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 3 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo3.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 4 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo4.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 5 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo5.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 6 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo6.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 7 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo7.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 8 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo8.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 9 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo9.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 10 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo10.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 11 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo11.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <!-- COLUMNS 12 -->
                                <div class="item">
                                    <div class="ow-client-logo">
                                        <div class="client-logo wt-img-effect on-color">
                                            <a href="javascript:;"><img src="{{ asset('assets/images/client-logo/logo12.png')}}" alt=""></a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="styleswitcher">
            ...
            <div class="styleswitcher-inner">
                ...
                <ul class="background-switcher">
                    <li><img src="{{ asset('assets/images/switcher/switcher-bg/thum/bg1.jpg')}}" rel="images/switcher/switcher-bg/large/bg1.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-bg/thum/bg2.jpg')}}" rel="images/switcher/switcher-bg/large/bg2.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-bg/thum/bg3.jpg')}}" rel="images/switcher/switcher-bg/large/bg3.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-bg/thum/bg4.jpg')}}" rel="images/switcher/switcher-bg/large/bg4.jpg')}}" alt=""></li>
                </ul>

                <h6 class="switcher-title">Background Pattern</h6>
                <ul class="pattern-switcher">
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg1.jpg')}}" rel="images/switcher/switcher-patterns/large/pt1.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg2.jpg')}}" rel="images/switcher/switcher-patterns/large/pt2.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg3.jpg')}}" rel="images/switcher/switcher-patterns/large/pt3.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg4.jpg')}}" rel="images/switcher/switcher-patterns/large/pt4.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg5.jpg')}}" rel="images/switcher/switcher-patterns/large/pt5.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg6.jpg')}}" rel="images/switcher/switcher-patterns/large/pt6.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg7.jpg')}}" rel="images/switcher/switcher-patterns/large/pt7.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg8.jpg')}}" rel="images/switcher/switcher-patterns/large/pt8.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg9.jpg')}}" rel="images/switcher/switcher-patterns/large/pt9.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg10.jpg')}}" rel="images/switcher/switcher-patterns/large/pt10.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg11.jpg')}}" rel="images/switcher/switcher-patterns/large/pt11.jpg')}}" alt=""></li>
                    <li><img src="{{ asset('assets/images/switcher/switcher-patterns/thum/bg12.jpg')}}" rel="images/switcher/switcher-patterns/large/pt12.jpg')}}" alt=""></li>
                </ul>
