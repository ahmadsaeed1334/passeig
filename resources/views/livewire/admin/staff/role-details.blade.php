<div wire:ignore.self class="modal fade" tabindex="-1" data-backdrop="static" id="roleDetailsModel" aria-hidden="true">

	<div class="modal-dialog modal-xl modal-dialog-scrollable">
		<div class="modal-content bg-light">
			<div class="modal-header">
				<h5 wire:click.prevent="$dispatch('refreshRole')" class="modal-title text-{{ primary_color() }} pointer"
							...
							<div class="card card-flush flex-row-fluid overflow-hidden py-4">
								...
								<div class="card-body scroll pt-0">
									...
									<div class="d-flex flex-column text-white-600">
										@foreach ($role->permissions->pluck('name') as $row)
								...
								{{-- <div class="card-footer pt-0">
									<button wire:click="edit('{{ $role->id }}')" type="button" class="btn btn-light btn-active-primary"
								...
								<div class="card-header pt-5">
									...
									<div class="card-title">
										<h2 class="d-flex align-items-center">Users Assigned
											<span class="fs-6 ms-1 text-white-600"> ({{ $role->users_count }})</span>
										</h2>
									</div>
									<!--end::Card title-->
									<!--begin::Card toolbar-->
										...
										<tbody class="fw-semibold text-white-600">
											@forelse ($role->users as $user)
												<tr>
													...
													<!--end::user=-->
													<!--begin::Joined date=-->
													<td>{{ diff_for_humans_long($user->created_at) }}</td>
													<!--end::Joined date=-->
												</tr>
											@empty
												{!! no_data() !!}
