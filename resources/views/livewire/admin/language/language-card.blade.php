						...
						<tr>
							...
							<td class="">
								<div class="d-flex align-items-center">
									...
									<div class="d-flex flex-column">
										<span class="text-dark font-weight-bolder fs-2 fw-bold mb-1">
											{{ Str::upper($lang) }}
							...
							<td class="text-center">
								{{-- @can('super language edit') --}}
									...
									<button wire:click="manageLanguage('{{ $lang }}')"
										class="btn btn-icon btn-light btn-active-light-{{ primary_color() }} btn-sm mr-3" {!! show_toltip('Update Translations') !!}>
										<span class="svg-icon svg-icon-md svg-icon-primary">
								...
								@if ($lang != 'en' && $lang != default_lang())
									{{-- @can('super language delete') --}}
										...
										<a wire:click.prevent="destroyLang('{{ $lang }}')" {!! confirm() !!} href="#"
											...
											data-bs-placement="top" title="Delete {{ Str::singular($page_title) }}">
