				...
				<div class="timeline">
						...
						<div class="timeline-content mt-n1 mb-10">
							...
							<div class="overflow-auto pb-5">
								...
								<div class="d-flex align-items-center min-w-750px mb-5 rounded border border-dashed border-gray-300 px-7 py-3">
									...
									<!--end::Label-->
									<!--begin::Users-->
									<div class="symbol-group symbol-hover flex-grow-1 min-w-100px pe-2 flex-nowrap">
										<!--begin::User-->
					...
					<div class="timeline-item">
						...
						<div class="timeline-content mt-n1 mb-10">
							...
							<div class="pe-3 mb-5">
								<!--begin::Title-->
								<a href="#" class="fs-5 fw-semibold text-hover-primary mb-2 text-gray-800">3 New Incoming Project
									Files:</a>
								<!--end::Title-->
								<!--begin::Description-->
								<div class="d-flex align-items-center fs-6 mt-1">
								...
								<div class="d-flex align-items-center min-w-700px rounded border border-dashed border-gray-300 p-5">
									...
									<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
										...
										<div class="ms-1 fw-semibold">
											<!--begin::Desc-->
											<a href="../../demo1/dist/apps/projects/project.html" class="fs-6 text-hover-primary fw-bold">Finance
								...
								<div class="d-flex align-items-center min-w-700px rounded border border-dashed border-gray-300 p-7">
									...
									<div class="overlay me-10">
										...
										<div class="overlay-wrapper">
											<img alt="img" class="w-150px rounded" src="{{ asset('assets/media/stock/600x400/img-29.jpg') }}" />
										</div>
										<!--end::Image-->
										<!--begin::Link-->
									...
									<div class="overlay me-10">
										<!--begin::Image-->
										<div class="overlay-wrapper">
											<img alt="img" class="w-150px rounded" src="{{ asset('assets/media/stock/600x400/img-31.jpg') }}" />
										</div>
										<!--end::Image-->
										<!--begin::Link-->
										<div class="overlay-layer bg-dark rounded bg-opacity-10">
									...
									<div class="overlay">
										<!--begin::Image-->
										<div class="overlay-wrapper">
											<img alt="img" class="w-150px rounded" src="{{ asset('assets/media/stock/600x400/img-40.jpg') }}" />
										</div>
										<!--end::Image-->
										<!--begin::Link-->
										<div class="overlay-layer bg-dark rounded bg-opacity-10">
								...
								<div
									...
									<div class="d-flex flex-stack flex-grow-1 flex-md-nowrap flex-wrap">
										...
										<div class="mb-md-0 fw-semibold mb-3">
											...
											<div class="fs-6 pe-7 text-gray-700">Login into Admin Dashboard to make sure the data integrity is OK
											</div>
										</div>
										<!--end::Content-->
										<!--begin::Action-->
