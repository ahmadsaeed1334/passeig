<div wire:ignore class="modal modal-sticky modal-sticky-lg modal-sticky-bottom-right" id="message_modal"
        ...
        <div class="modal-content">
            ...
            <form>
                ...
                <div class="d-flex align-items-center justify-content-between py-5 pl-8 pr-5 border-bottom">
                    <h5 class="font-weight-bold m-0">Compose Mail For: <span
                            class="text-primary">{{ Str::title($name) }}</span></h5>
                    <div class="d-flex ml-2">
                        <span wire:click.prevent="$emitSelf('refresh')" class="btn btn-clean btn-sm btn-icon mr-2">
                            <i class="flaticon2-arrow-1 icon-1x"></i>
                        </span>
                        <span wire:click.prevent="$emitUp('closeMessage')" class="btn btn-clean btn-sm btn-icon"
                            data-dismiss="modal">
                ...
                <div class="d-block">
                    ...
                    <div class="d-flex align-items-center border-bottom inbox-to px-8 min-h-45px">
                        ...
                        <div class="d-flex align-items-center flex-grow-1">
                            <input wire:model.defer="email" type="text" class="form-control border-0" name="compose_to"
                    ...
                    <div class="border-bottom mb-5">
                        <input wire:model.defer="subject" class="form-control border-0 px-8 min-h-45px"
                    ...
                    <!--end::Subject-->
                    <!--begin::Message-->
                    <div wire:ignore class="border-0" style="height: 250px">
                        <trix-editor class="trix-content editor200" x-ref="trix" wire:model.debounce.100000ms="message"
                            wire:key="trix-content-message-unique-key" placeholder="Type a message">
                        </trix-editor>
                    </div>
                    @error('message')
                        <div class="text-danger">{{ $message }}</div>
                ...
                <div class="d-flex align-items-center justify-content-between py-5 pl-8 pr-5 border-top">
                    ...
                    <div class="d-flex align-items-center mr-3">
                        ...
                        <div class="btn-group mr-4">
                            <span wire:click.prevent="send_Email()"
                            ...
                            {{-- <span class="btn btn-primary font-weight-bold dropdown-toggle dropdown-toggle-split"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="button"></span>
