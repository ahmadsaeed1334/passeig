<div wire:ignore.self class="modal fade" id="giveawaySpecificationEditModal" tabindex="-1" aria-labelledby="giveawaySpecificationEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="giveawaySpecificationEditModalLabel">Edit Giveaway giveaway-specifications </h5>
