...
<div wire:ignore.self class="modal fade" id="editGiveawayModal" tabindex="-1" aria-labelledby="editGiveawayModalLabel" aria-hidden="true">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editGiveawayModalLabel">Edit Giveaway</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form wire:submit.prevent="update" id="editGiveawayModel_form" class="form" action="#" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Input group-->
...
<div wire:ignore.self class="modal fade" id="contestTopEditModal" tabindex="-1" aria-labelledby="contestTopEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="contestTopEditModalLabel">Edit Contest Top </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form wire:submit.prevent="updateContestTop">
                    <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" wire:click="updateContestTop">update</button>
                    </div>
                </form>
            </div>
        </div>
