				...
				<div class="row g-5 g-xl-10 mb-xl-10 mb-5">
						...
						<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-xl-10 mb-5"
							...
							<div class="card-header pt-5">
								...
								<div class="card-title d-flex flex-column">
									<!--begin::Amount-->
									<span class="fs-2hx fw-bold me-2 lh-1 ls-n2 text-white">69</span>
									<!--end::Amount-->
									<!--begin::Subtitle-->
							...
							<div class="card-body d-flex align-items-end pt-0">
								...
								<div class="d-flex align-items-center flex-column w-100 mt-3">
									<div class="d-flex justify-content-between fw-bold fs-6 w-100 mt-auto mb-2 text-white opacity-75">
					...
					<div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
						...
						<div class="card card-flush h-md-50 mb-xl-10 mb-5">
							...
							<div class="card-header pt-5">
								...
								<div class="card-title d-flex flex-column">
									...
									<div class="d-flex align-items-center">
										<!--begin::Currency-->
										<span class="fs-4 fw-semibold me-1 align-self-start text-gray-400">$</span>
										<!--end::Currency-->
										<!--begin::Amount-->
							...
							<!--end::Header-->
							<!--begin::Card body-->
							<div class="card-body d-flex align-items-center flex-wrap pt-2 pb-4">
								<!--begin::Chart-->
					...
					<div class="col-xxl-6">
						...
						@livewire('admin.partial.online-users')
							...
							<div class="card-header pt-5">
								...
								<div class="card-toolbar">
									<ul class="nav" id="kt_chart_widget_8_tabs">
										...
										<li class="nav-item">
											<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold me-1 active px-4"
								...
								<div class="tab-content">
									...
									<div class="tab-pane fade" id="kt_chart_widget_8_week_tab" role="tabpanel">
										...
										<div class="mb-5">
											...
											<div class="d-flex align-items-center mb-2">
												<span class="fs-1 fw-semibold me-1 mt-n1 text-gray-400">$</span>
												<span class="fs-3x fw-bold me-2 lh-1 ls-n2 text-gray-800">18,89</span>
												<span class="badge badge-light-success fs-base">
													<!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
													<span class="svg-icon svg-icon-5 svg-icon-success ms-n1">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
									...
									<div class="tab-pane fade active show" id="kt_chart_widget_8_month_tab" role="tabpanel">
										...
										<div class="mb-5">
											...
											<div class="d-flex align-items-center mb-2">
												<span class="fs-1 fw-semibold me-1 mt-n1 text-gray-400">$</span>
												<span class="fs-3x fw-bold me-2 lh-1 ls-n2 text-gray-800">8,55</span>
												<span class="badge badge-light-success fs-base">
													<!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
													<span class="svg-icon svg-icon-5 svg-icon-success ms-n1">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
							...
							<div class="card-body pt-6">
								...
								<ul class="nav nav-pills nav-pills-custom mb-3">
									...
									<li class="nav-item me-3 me-lg-6 mb-3">
										<!--begin::Link-->
										<a
											class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px active overflow-hidden pt-5 pb-2"
									...
									<li class="nav-item me-3 me-lg-6 mb-3">
										<!--begin::Link-->
										<a
											class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column w-80px h-85px overflow-hidden pt-5 pb-2"
											...
											<table class="table-row-dashed gs-0 gy-3 my-0 table align-middle">
												...
												<thead>
													<tr class="fs-7 fw-bold border-bottom-0 text-gray-400">
														...
														<th class="w-125px pe-7 p-0 pb-3 text-end">CHART</th>
															...
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Guy Hawkins</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Haiti</span>
																</div>
															</div>
														</td>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Jane Cooper</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Monaco</span>
																</div>
															</div>
														</td>
														<td class="pe-13 text-end">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Jacob Jones</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Poland</span>
																</div>
															</div>
														</td>
														<td class="pe-13 text-end">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Cody Fishers</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Mexico</span>
																</div>
															</div>
														</td>
														<td class="pe-13 text-end">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Brooklyn Simmons</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Poland</span>
																</div>
															</div>
														</td>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Esther Howard</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Mexico</span>
																</div>
															</div>
														</td>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Annette Black</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Haiti</span>
																</div>
															</div>
														</td>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Marvin McKinney</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Monaco</span>
																</div>
															</div>
														</td>
														...
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Jacob Jones</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">New York</span>
																</div>
															</div>
														</td>
														<td class="pe-13 text-end">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Ronald Richards</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Madrid</span>
																</div>
															</div>
														</td>
														<td class="pe-13 text-end">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Leslie Alexander</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Pune</span>
																</div>
															</div>
														</td>
														<td class="pe-13 text-end">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Courtney Henry</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Mexico</span>
																</div>
															</div>
														</td>
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Arlene McCoy</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">London</span>
																</div>
															</div>
														</td>
														<td class="pe-13 text-end">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Marvin McKinneyr</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Monaco</span>
																</div>
															</div>
														</td>
														...
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Jacob Jones</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">PManila</span>
																</div>
															</div>
														</td>
														<td class="pe-13 text-end">
														...
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Esther Howard</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Iceland</span>
																</div>
															</div>
														</td>
														<td class="pe-13 text-end">
														...
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Esther Howard</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Kiribati</span>
																</div>
															</div>
														</td>
														<td class="pe-13 text-end">
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																...
																<div class="d-flex justify-content-start flex-column">
																	<a href="../../demo1/dist/pages/user-profile/overview.html"
																		class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Ralph Edwards</a>
																	<span class="fw-semibold d-block fs-7 text-gray-400">Mexico</span>
																</div>
															</div>
														</td>
								...
								<div class="row gx-9 h-100">
									...
									<div class="col-sm-6">
										...
										<div class="d-flex flex-column h-100">
											...
											<div class="mb-7">
												...
												<div class="d-flex flex-stack mb-6">
													...
													<div class="me-5 flex-shrink-0">
														<span class="fs-7 fw-bold me-2 d-block lh-1 pb-1 text-gray-400">Featured</span>
														<span class="fs-1 fw-bold text-gray-800">9 Degree</span>
													</div>
													<!--end::Title-->
													<span class="badge badge-light-primary align-self-center fs-7 flex-shrink-0 py-3 px-4">In
														Process</span>
												</div>
												<!--end::Heading-->
												<!--begin::Items-->
												<div class="d-flex align-items-center d-grid flex-wrap gap-2">
													...
													<div class="d-flex align-items-center me-5 me-xl-13">
														...
														<!--begin::Info-->
														<div class="m-0">
															<span class="fw-semibold d-block fs-8 text-gray-400">Manager</span>
															<a href="../../demo1/dist/pages/user-profile/overview.html"
																class="fw-bold text-hover-primary fs-7 text-gray-800">Robert Fox</a>
														</div>
														<!--end::Info-->
													</div>
													<!--end::Item-->
													...
													<div class="d-flex align-items-center">
														...
														<!--begin::Info-->
														<div class="m-0">
															<span class="fw-semibold d-block fs-8 text-gray-400">Budget</span>
											...
											<div class="mb-6">
												<!--begin::Text-->
												<span class="fw-semibold fs-6 d-block mb-8 text-gray-600">Flat cartoony illustrations with vivid
													unblended colors and asymmetrical beautiful purple hair lady</span>
												<!--end::Text-->
												<!--begin::Stats-->
												<div class="d-flex">
													<!--begin::Stat-->
													<div class="min-w-100px w-100 me-6 mb-3 rounded border border-dashed border-gray-300 py-2 px-4">
														<!--begin::Date-->
													...
													<!--end::Stat-->
													<!--begin::Stat-->
													<div class="min-w-100px w-100 mb-3 rounded border border-dashed border-gray-300 py-2 px-4">
														<!--begin::Number-->
							...
							<div class="card-header mb-6 pt-5">
								...
								<h3 class="card-title align-items-start flex-column">
									...
									<div class="d-flex align-items-center mb-2">
										...
										<!--end::Currency-->
										<!--begin::Value-->
										<span class="fs-2hx fw-bold me-2 lh-1 ls-n2 text-gray-800">3,274.94</span>
										<!--end::Value-->
										<!--begin::Label-->
										<span class="badge badge-light-success fs-base">
											<!--begin::Svg Icon | path: icons/duotune/arrows/arr066.svg-->
										...
										<div class="table-responsive mt-n6 mx-9">
											...
											<table class="gs-0 gy-4 table align-middle">
												...
												<tbody>
													...
													<tr>
														<td>
															<a href="#" class="fw-bold fs-6 text-gray-600">11:35 AM</a>
														</td>
														<td class="pe-0 text-end">
										...
										<div class="table-responsive mt-n6 mx-9">
											...
											<table class="gs-0 gy-4 table align-middle">
												...
												<tbody>
													...
													<tr>
														<td>
															<a href="#" class="fw-bold fs-6 text-gray-600">12:30 AM</a>
														</td>
														<td class="pe-0 text-end">
															<span class="fw-bold fs-6 me-1 text-gray-800">$2,756.26</span>
														</td>
										...
										<div class="table-responsive mt-n6 mx-9">
											...
											<table class="gs-0 gy-4 table align-middle">
												...
												<tbody>
													...
													<tr>
														<td>
															<a href="#" class="fw-bold fs-6 text-gray-600">10:30 PM</a>
														</td>
														<td class="pe-0 text-end">
															<span class="fw-bold fs-6 me-1 text-gray-800">$1.756.26</span>
														</td>
									...
									<table class="table-row-dashed gs-0 gy-3 my-0 table align-middle">
										...
										<thead>
											<tr class="fs-7 fw-bold border-bottom-0 text-gray-400">
												...
												<th class="min-w-175px pe-12 p-0 pb-3 text-end">STATUS</th>
												<th class="w-125px pe-7 p-0 pb-3 text-end">CHART</th>
												<th class="w-50px p-0 pb-3 text-end">VIEW</th>
											</tr>
										</thead>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="d-flex justify-content-start flex-column">
															<a href="#" class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Mivy App</a>
															<span class="fw-semibold d-block fs-7 text-gray-400">Jane Cooper</span>
														</div>
													</div>
												</td>
												<td class="pe-0 text-end">
												...
												<td class="pe-12 text-end">
													<span class="badge fs-7 badge-light-primary py-3 px-4">In Process</span>
												</td>
												<td class="pe-0 text-end">
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="d-flex justify-content-start flex-column">
															<a href="#" class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Avionica</a>
															<span class="fw-semibold d-block fs-7 text-gray-400">Esther Howard</span>
														</div>
													</div>
												</td>
												<td class="pe-0 text-end">
												...
												<td class="pe-12 text-end">
													<span class="badge fs-7 badge-light-warning py-3 px-4">On Hold</span>
												</td>
												<td class="pe-0 text-end">
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="d-flex justify-content-start flex-column">
															<a href="#" class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Charto CRM</a>
															<span class="fw-semibold d-block fs-7 text-gray-400">Jenny Wilson</span>
														</div>
													</div>
												</td>
												<td class="pe-0 text-end">
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="d-flex justify-content-start flex-column">
															<a href="#" class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">Tower Hill</a>
															<span class="fw-semibold d-block fs-7 text-gray-400">Cody Fisher</span>
														</div>
													</div>
												</td>
												<td class="pe-0 text-end">
												...
												<td class="pe-12 text-end">
													<span class="badge fs-7 badge-light-success py-3 px-4">Complated</span>
												</td>
												<td class="pe-0 text-end">
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<div class="d-flex justify-content-start flex-column">
															<a href="#" class="fw-bold text-hover-primary fs-6 mb-1 text-gray-800">9 Degree</a>
															<span class="fw-semibold d-block fs-7 text-gray-400">Savannah Nguyen</span>
														</div>
													</div>
												</td>
												<td class="pe-0 text-end">
					...
					<div class="col-xl-4">
						...
						<div class="card card-flush h-xl-100">
							...
							<div class="card-header mb-7 pt-7">
								...
								<!--begin::Toolbar-->
								<div class="card-toolbar">
									<a href="../../demo1/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-sm btn-light">PDF
										Report</a>
								</div>
								<!--end::Toolbar-->
							</div>
