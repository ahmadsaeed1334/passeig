<div wire:ignore.self class="modal fade" id="contestCardsAddModal" tabindex="-1" aria-labelledby="contestCardsAddModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="contestCardsAddModalLabel">Add Contest Cards</h5>
