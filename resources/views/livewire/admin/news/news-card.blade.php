<div class="card card-flush">
    ...
    <div class="card-header mt-6">
        ...
        <div class="card-toolbar">
            ...
            <button type="button" class="btn btn-light-{{ setting('general_settings.primary_color') }}" data-bs-toggle="modal" data-bs-target="#addSlidesModel">
        ...
        <table class="table-row-dashed fs-6 gy-5 mb-0 table align-middle" id="kt_positions_table">
            ...
            <tbody class="fw-semibold text-gray-600">
                ...
                <tr class="">
                    ...
                    <!--end::Name=-->
                    <td class="text-white font-weight-bolder mb-1">
                        {{ $slide['message'] }}
                    </td>
                    <td class="text-white font-weight-bolder mb-1">
                        @if ($slide['user_id'] == 0)
                    ...
                    <td class="text-end">
                        <!--begin::Update-->
                        <button wire:click="edit('{{ $index }}')" class="btn btn-icon btn-active-light-{{ setting('general_settings.primary_color') }} w-30px h-30px me-2" data-bs-toggle="modal" data-bs-target="#addSlidesModel" {!! show_toltip('Update slide') !!}>
                            <i class="fa-solid fa-pen-to-square fs-6 fw-bold fw-bolder"></i>
                        </button>
                        <!--end::Update-->
                        <!--begin::Update-->
                        <a wire:click.prevent="delete('{{ $index }}')" {!! confirm() !!} href="#" class="btn btn-sm btn-icon btn-active-light-danger w-30px h-30px me-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title="Delete slide">
