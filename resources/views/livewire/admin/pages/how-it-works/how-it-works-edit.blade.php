<div wire:ignore.self class="modal fade" id="howItWorkEditModal" tabindex="-1" aria-labelledby="howItWorkEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="howItWorkEditModalLabel">Edit How to Work</h5>
