<div wire:ignore.self class="modal fade" id="howItWordAddModal" tabindex="-1" aria-labelledby="howItWordAddModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="howItWordAddModalLabel">Add How To Work</h5>
