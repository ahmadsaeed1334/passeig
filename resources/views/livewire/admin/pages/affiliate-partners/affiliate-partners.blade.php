            ...
            <div id="kt_app_toolbar_container" class="app-container container{{ general('layout') }} d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                    ...
                    <h1 wire:click.prevent="$dispatch('refresh')" class="page-heading d-flex text-{{ primary_color() }} fw-bold fs-3 flex-column justify-content-center pointer my-0">
                        ...
                        {{ $page_title ?? 'Affiliate Partner' }}
                    </h1>
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						<!--begin::Item-->
						<div class="breadcrumb-item text-muted">
							{{ __('total') }} {{ 'Affiliate Partner'}}
						</div>
						<!--end::Item-->
						<!--begin::Item-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container{{ general('layout') }}">
                ...
                <div class="card card-flush">
                    {{-- @include('livewire.admin.pages.affiliate-partners.affiliate-partners-cart') --}}
                    @include('livewire.admin.pages.affiliate-partners.affiliate-partners-view')
                    <!--end::View-->
                </div>
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <!--begin::Content container-->
                    <div id="kt_app_content_container" class="app-container container{{ general('layout') }}">
                        @include('livewire.admin.pages.affiliate-partners.affiliate-partners-edit')
                        {{-- @include('livewire.admin.pages.affiliate-partners.affiliate-partners-form') --}}
