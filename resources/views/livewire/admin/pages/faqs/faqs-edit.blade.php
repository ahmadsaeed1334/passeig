<div wire:ignore.self class="modal fade" id="faqEditModal" tabindex="-1" aria-labelledby="faqEditModalModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="faqEditModalModalLabel">Edit FAQ </h5>
...
<div wire:ignore.self class="modal fade" id="faqTopEditModal" tabindex="-1" aria-labelledby="faqTopEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="faqEditTopModalLabel">Edit FAQ Top </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form wire:submit.prevent="updateFaqTops">
                    <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" wire:click="discardChanges" data-bs-dismiss="modal">Discard</button>
                        <button type="button" class="btn btn-primary" wire:click="updateFaqTops">update</button>
                    </div>
                </form>
            </div>
        </div>
