        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container{{ general('layout') }}">
                ...
                <div class="card card-flush">
                    {{-- @include('livewire.admin.pages.buy-tickets.buy-tickets-cart') --}}
                    @include('livewire.admin.pages.buy-tickets.buy-tickets-view')
                    <!--end::View-->
                </div>
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <!--begin::Content container-->
                    <div id="kt_app_content_container" class="app-container container{{ general('layout') }}">
                        @include('livewire.admin.pages.buy-tickets.buy-tickets-edit')
                        {{-- @include('livewire.admin.pages.buy-tickets.buy-tickets-form') --}}
