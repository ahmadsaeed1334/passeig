<div wire:ignore.self class="modal fade" id="topAffiliateEditModal" tabindex="-1" aria-labelledby="topAffiliateEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="topAffiliateEditModalLabel">Edit Top Affiliate </h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="update">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <label class="fs-6 fw-semibold form-label mb-2 mt-2">
                                <span class="required mt-2">Card Image 1</span>
                            </label>
                            <br>
                            <div class="image-input image-input-outline align-items-center" style="background-image: url({{ asset('img/bg-back.jpg') }}); background-size:100% 100%;width:300px">
                                ...
                                <label class="btn btn-icon btn-circle btn-active-color-{{ primary_color() }} w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change card_icon_1">
                                    ...
                                    <input wire:model="card_image_1" type="file" id="card_icon_1" name="file" accept=".jpeg, .png, .jpg, .gif, .mp4, .mov, .ogg, .qt" />
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                        <label for="card_name_1" class="form-label required mt-2">Card Name 1</label>
                        ...
                        <div class="col-lg-6">
                        <label for="card_amount_1" class="form-label required mt-2">Card Amount 1</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <label class="fs-6 fw-semibold form-label mb-2 mt-2">
                                <span class="required mt-2">Card image 2</span>
                            </label>
                            <br>
                            <div class="image-input image-input-outline align-items-center" style="background-image: url({{ asset('img/bg-back.jpg') }}); background-size:100% 100%;width:300px">
                                <!-- Preview existing file -->
                                ...
                                <!-- Inputs -->
                                <label class="btn btn-icon btn-circle btn-active-color-{{ primary_color() }} w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" name="Change card_image_2">
                                    <i class="bi bi-pencil-fill fs-7"></i>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label for="card_name_2" class="form-label required mt-2">Card Name 2</label>
                            ...
                            <div class="col-lg-6">
                            <label for="card_amount_2" class="form-label required mt-2">Card Amount 2</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <label class="fs-6 fw-semibold form-label mb-2 mt-2">
                                    <span class="required mt-2">Card image 3</span>
                                </label>
                                <br>
                                <div class="image-input image-input-outline align-items-center" style="background-image: url({{ asset('img/bg-back.jpg') }}); background-size:100% 100%;width:300px">
                                    <!-- Preview existing file -->
                                    ...
                                    <!-- Inputs -->
                                    <label class="btn btn-icon  btn-circle btn-active-color-{{ primary_color() }} w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" name="Change card_image_3">
                                        <i class="bi bi-pencil-fill fs-7"></i>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                            <label for="card_name_3" class="form-label required mt-2">Card Name 3</label>
                            ...
                            <div class="col-lg-6">
                            <label for="card_amount_3" class="form-label required mt-2">Card Amount 3</label>
