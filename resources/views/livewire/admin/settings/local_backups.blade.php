	...
	<div class="card card-custom card-stretch gutter-b">
		...
		<div class="card-header border-0 py-5">
			<h3 class="card-title align-items-start flex-column">
				<span class="card-label font-weight-bolder text-dark">Local Backups</span>
							...
							<tr>
								...
								@if (auth()->user()->user_type == -1)
									<td class="pr-0 text-right">
										<a wire:click.prevent="download('{{ $file }}')" href=""
											class="btn btn-icon btn-light btn-hover-{{ primary_color() }} btn-sm">
											<span class="svg-icon svg-icon-md svg-icon-primary">
												<!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Files\Cloud-download.svg--><svg
										...
										<a wire:click.prevent="delete('{{ $file }}')" href="javacript:;"
											class="btn btn-icon btn-light btn-hover-{{ primary_color() }} btn-sm">
											<span class="svg-icon svg-icon-md svg-icon-danger">
												<!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Trash.svg--><svg
													xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
													viewBox="0 0 24 24" version="1.1">
													<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
