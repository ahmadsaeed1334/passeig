    ...
    <div class="card card-custom card-stretch gutter-b">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-white">DropBox Backups</span>
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span wire:click.prevent="downloadDropBox('{{ $file }}')" class="text-hover-{{ primary_color() }} pointer text-gray-800">{{ \File::basename($file) }}</span>
                            ...
                            <td class="pr-0 text-right">
                                <a wire:click.prevent="downloadDropBox('{{ $file }}')" href="javacript:;" class="btn btn-icon btn-light btn-hover-{{ primary_color() }} btn-sm">
                                ...
                                <a wire:click.prevent="deleteDropBox('{{ $file }}')" href="javacript:;" class="btn btn-icon btn-light btn-hover-{{ primary_color() }} btn-sm">
