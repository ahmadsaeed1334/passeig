{{-- <div wire:ignore.self class="modal fade" id="productAddModal" tabindex="-1" aria-labelledby="productAddModalLabel" aria-hidden="true">
    ...
    color: black; 
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="productAddModalLabel">Add Products</h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="create">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea wire:model="short_description" class="form-control" id="short_description" rows="3"></textarea>
                        @error('short_description') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="mb-3">
                        <label for="categorie_id" class="form-label required">Category</label>
                        <select wire:model="categorie_id" class="form-control" id="categorie_id">
