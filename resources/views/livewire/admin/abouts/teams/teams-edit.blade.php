<div wire:ignore.self class="modal fade" id="teamsEditModal" tabindex="-1" aria-labelledby="teamsEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="teamsEditModalLabel">Edit Teams</h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="update">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <label class="fs-6 fw-semibold form-label mb-2 mt-2">
                                <span class="required mt-2">Team Image 1</span>
                            </label>
                            <br>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                        <label for="team_name_1" class="form-label required mt-2">Team Name 1</label>
                        ...
                        <div class="col-lg-6">
                        <label for="team_designation_1" class="form-label required mt-2">Team Designation 1</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <label class="fs-6 fw-semibold form-label mb-2 mt-2">
                                <span class="required mt-2">Team Image 2</span>
                            </label>
                            <br>
                            <div class="image-input image-input-outline align-items-center" style="background-image: url({{ asset('img/bg-back.jpg') }}); background-size:100% 100%;width:300px">
                                <!-- Preview existing file -->
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                        <label for="team_name_2" class="form-label required mt-2">Team Name 2</label>
                        ...
                        <div class="col-lg-6">
                        <label for="team_designation_2" class="form-label required mt-2">Team Designation 2</label>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <label class="fs-6 fw-semibold form-label mb-2 mt-2">
                                <span class="required mt-2">Team Image 3</span>
                            </label>
                            <br>
                            <div class="image-input image-input-outline align-items-center" style="background-image: url({{ asset('img/bg-back.jpg') }}); background-size:100% 100%;width:300px">
                                <!-- Preview existing file -->
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                        <label for="team_name_3" class="form-label required mt-2">Team Name 3</label>
                        ...
                        <div class="col-lg-6">
                        <label for="team_designation_3" class="form-label required mt-2">Team Designation 3</label>
