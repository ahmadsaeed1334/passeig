<div wire:ignore.self class="modal fade" id="bannerImageAddModal" tabindex="-1" aria-labelledby="bannerImageAddModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bannerImageAddModalLabel">Add Banner Slider Image </h5>
