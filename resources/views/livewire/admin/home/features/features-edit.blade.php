<div wire:ignore.self class="modal fade" id="featureEditModal" tabindex="-1" aria-labelledby="featureEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="featureEditModalLabel">Edit Features</h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="update">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                        <label for="description" class="form-label required mt-2 mt-2">Description</label>
