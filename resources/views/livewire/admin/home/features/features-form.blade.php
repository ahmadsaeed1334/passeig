<div wire:ignore.self class="modal fade" id="featuresAddModal" tabindex="-1" aria-labelledby="featuresAddModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="featuresAddModalLabel">Add Feactures</h5>
