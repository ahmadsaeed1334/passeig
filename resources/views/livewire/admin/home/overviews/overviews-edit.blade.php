<div wire:ignore.self class="modal fade" id="overviewEditModal" tabindex="-1" aria-labelledby="overviewEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="overviewEditModalLabel">Edit Overview</h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="update">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6">
                            <label for="card_number_2" class="form-label required mt-2">Card Number 2</label>
                            <input wire:model="card_number_2" class="form-control" id="card_number_2" rows="3"></input>
                            @error('card_number_2') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="image-input image-input-outline align-items-center" style="background-image: url({{ asset('img/bg-back.jpg') }}); background-size:100% 100%;width:300px">
                                    ...
                                    <label class="btn btn-icon btn-circle btn-active-color-{{ primary_color() }} w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change card_icon_3">
                                        <i class="bi bi-pencil-fill fs-7"></i>
                                        <input wire:model="card_icon_3" type="file" id="card_icon_3" name="file" accept=".jpeg, .png, .jpg, .gif, .mp4, .mov, .ogg, .qt" />
                                        <input type="hidden" name="avatar_remove" />
                                    </label>             
                                    @error('card_icon_3')
                                    <div class="text-{{ primary_color() }}">{{ $message }}</div>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                            <label for="card_number_3" class="form-label required mt-2">Card Number 3</label>
                            <input wire:model="card_number_3" class="form-control" id="card_number_3" rows="3"></input>
                            @error('card_number_3') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="col-lg-6">
