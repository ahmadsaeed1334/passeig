<div wire:ignore.self class="modal fade" id="overviewAddModal" tabindex="-1" aria-labelledby="overviewAddModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="overviewAddModalLabel">Add Overview</h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="create">
                    ...
                    <div class="mb-3"> 
                        ...
                        <div class="mb-3">
                            <label for="card_number_2" class="form-label required">Card Number 2</label>
                        ...
                        <div class="mb-3">
                            <label for="card_number_3" class="form-label required">Card Number 3</label>
