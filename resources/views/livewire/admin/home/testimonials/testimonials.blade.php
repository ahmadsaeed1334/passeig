        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container{{ general('layout') }}">
                ...
                <div class="card card-flush">
                    {{-- @include('livewire.admin.home.testimonials.testimonials-cart') --}}
                    @include('livewire.admin.home.testimonials.testimonials-view')
                    <!--end::View-->
                </div>
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <!--begin::Content container-->
                    <div id="kt_app_content_container" class="app-container container{{ general('layout') }}">
                        @include('livewire.admin.home.testimonials.testimonials-edit')
                        {{-- @include('livewire.admin.home.testimonials.testimonials-form') --}}
