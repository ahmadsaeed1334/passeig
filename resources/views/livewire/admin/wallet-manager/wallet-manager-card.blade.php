...
<div class="card-header mt-6">
    ...
    @can('super staff create')
        ...
        <div class="card-toolbar">
            ...
            data-bs-toggle="modal" data-bs-target="#assignAddModal">
        ...
        Assign Coins to User
    </button>
            <button wire:click="$set('isOpen', true)" type="button" class="btn btn-light-{{ primary_color() }}"
            data-bs-toggle="modal" data-bs-target="#deductAddModal">
        <!--begin::Svg Icon | path: icons/duotune/general/gen035.svg-->
        <span class="svg-icon svg-icon-3">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect opacity="0.3" x="2" y="2" width="20" height="20" rx="5"
      ...
      Deduct Amount To User
    </button>
            {{-- <button wire:click="$set('isOpen', true)" type="button" class="btn btn-light-{{ primary_color() }}"
            data-bs-toggle="modal" data-bs-target="#footerTextAddModal">
        <!--begin::Svg Icon | path: icons/duotune/general/gen035.svg-->
        <span class="svg-icon svg-icon-3">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect opacity="0.3" x="2" y="2" width="20" height="20" rx="5"
