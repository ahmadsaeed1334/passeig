<div wire:ignore.self class="modal fade" id="blogAddModal" tabindex="-1" aria-labelledby="blogAddModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="blogAddModalLabel">Add Blogs</h5>
            ...
            <div class="modal-body">
                <form wire:submit.prevent="create">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="button" wire:model="button" class="form-control">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-4">
                            ...
                            <div class="image-input image-input-outline align-items-center" style="background-image: url({{ asset('img/bg-back.jpg') }}); background-size:100% 100%;width:300px">
                                <div class="image-input-wrapper" style="background-image: url({{ $image ? (is_string($image) ? asset('storage/'.$image) : $image->temporaryUrl()) : asset('img/bg-back.jpg') }}); background-size:100% 100%;width:300px"></div>
