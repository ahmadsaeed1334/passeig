<div wire:ignore.self class="modal fade" id="blogEditModal" tabindex="-1" aria-labelledby="blogEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="blogEditModalLabel">Edit Blogs </h5>
