        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container{{ general('layout') }}">
                ...
                <div class="card card-flush">
                    @include('livewire.admin.blogs.blogs-cart')
                    @include('livewire.admin.blogs.blogs-view')
                    <!--end::View-->
                </div>
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <!--begin::Content container-->
                    <div id="kt_app_content_container" class="app-container container{{ general('layout') }}">
                        @include('livewire.admin.blogs.blogs-edit')
                        @include('livewire.admin.blogs.blogs-form')
                    </div>
                </div>
            </div>
        </div>
