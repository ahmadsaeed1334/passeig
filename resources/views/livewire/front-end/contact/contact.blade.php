                ...
                <div class="contact-info-wrapper">
                  <div class="d-flex flex-wrap justify-content-between w-100">
                    <div class="contact-info">
                      <div class="contact-info__icon"><img src="{{ asset('front-end/assets/images/icon/contact/1.png')}}" alt="image"></div>
                      <div class="contact-info__content">
                        <p>Phone Number</p>
                        <span>{{$support->card_number_1}}</span>
                      </div>
                    </div><!-- contact-info end -->
                    <div class="contact-info">
                      <div class="contact-info__icon"><img src="{{ asset('front-end/assets/images/icon/contact/2.png')}}" alt="image"></div>
                      <div class="contact-info__content">
                        <p>Email</p>
                        <span><a href="{{$support->card_email_1}}" class="__cf_email__" data-cfemail="f891969e97b88a919e99d69b9795">[email&#160;protected]</a></span>
                      </div>
                    </div><!-- contact-info end -->
                  </div>
                  <div class="contact-thumb"><img src="{{ asset('front-end/assets/images/elements/contact.png')}}" alt="image"></div>
                </div>
                @endforeach
              </div>
            </div>
