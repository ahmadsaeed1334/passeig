<div>
  <div  wire:ignore.self class="modal fade" id="signupModal" tabindex="1" role="dialog" aria-hidden="true">
  ...
  @include('livewire.front-end.partial.email-verification-modal')
    <!-- Your existing sign-up form -->
<script>
document.addEventListener('livewire:load', function () {
    Livewire.on('verification-modal', () => {
