<section class="position-relative pt-120 pb-120">
    <div class="bg-el"><img src="{{ asset('front-end/assets/images/bg/winner.jpg')}}" alt="image"></div>
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="winner-wrapper">
            <div class="left">
              <div class="winner-prize-thumb wow bounceIn" data-wow-duration="0.5s" data-wow-delay="0.5s"><img src="{{ asset('front-end/assets/images/elements/car.png')}}" alt="image"></div>
            </div>
            <div class="right">
              <div class="winner-slider">
                <div class="winner-slide-item">
                  <div class="winner-thumb"><img src="{{ asset('front-end/assets/images/winner/w-1.png')}}" alt="image"></div>
                  <div class="winner-content bg_img" data-background="{{ asset('front-end/assets/images/elements/winner-content-bg.jpg')}}">
