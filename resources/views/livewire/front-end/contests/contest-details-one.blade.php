<div>
  ...
  <section wire:ignore class="pb-120 mt-minus-300">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-lg-12">
            ...
            <div class="contest-cart__left">
              <div class="contest-cart__slider-area">
                <div class="contest-cart__thumb-slider">
                  ...
                  {{--<div class="single-slide"><img src="{{ asset('front-end/assets/images/contest/b1.png')}}" alt="image">
                </div>
          ...
          <div class="contest-cart__right">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center mb-30">
              <div class="select-quantity">
                <span class="caption">Quantity</span>
                <div class="quantity">
                  {{-- <input type="number" min="1" max="100" max="{{ $giveaway->quantity }}" wire:model="quantity" step="1" wire:change="$dispatch('updateTotalCost')" > --}}
                  <input type="number" id="quantity" wire:model="quantity"  wire:change="updatedQuantity" min="1" max="100">

                  {{-- <input type="number" min="1" max="100" wire:model.defer="quantity" step="1"> --}}
                </div>
              </div><!-- select-quantity end -->
              <div class="mt-sm-0 mt-3">
                <button wire:click="buyTickets"  wire:loading.class="loading" class="cmn-btn style--three">Buy Tickets</button> 
                <div>
    ...
    cursor: wait;
              ...
              @include('livewire.front-end.contests.style')
              <ul class="radio-switch ">
                <li class="radio-switch__item">
                  <input wire:model="walletType" name="walletType" value="personal" class="radio-switch__input ri5-sr-only " type="radio" name="radio-switch-name" id="radio-1" checked>
                  <label class="radio-switch__label" for="radio-1">Personal</label>
                </li>
                <li class="radio-switch__item">
                  <input wire:model="walletType" name="walletType" value="business" class="radio-switch__input ri5-sr-only" type="radio" name="radio-switch-name" id="radio-2" >
                  <label class="radio-switch__label" for="radio-2">Business</label>
                  <div aria-hidden="true" class="radio-switch__marker"></div>
                </li>
              </ul>
              @include('livewire.front-end.contests.script')
              
            </div>
            <ul class="social-links align-items-center pt-20">
              <li>Share :</li>
...
@else
    <div class="col-lg-12">
        <p>The requested giveaway does not exist.</p>
    </div>
@endif
</div>