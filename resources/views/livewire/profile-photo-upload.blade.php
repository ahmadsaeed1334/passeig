<div>
    ...
    <div class="profile-photo text-center">
        <img id="profileImage" src="{{ asset(auth()->user()->profile_photo_path ? 'storage/' . auth()->user()->profile_photo_path : 'assets/images/Bitmap.png') }}" alt="Profile Photo" width="120px" class="img-radius mt-5">
