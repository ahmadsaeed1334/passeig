            ...
            <div wire:ignore class="section-content">
                <div class="owl-carousel our-pricing-carousel owl-btn-vertical-center owl-btn-hover nav nav-tabs">
                    ...
                    <div class="item {{ $loop->first ? 'active-arrow active' : '' }}">
                        <a data-bs-toggle="tab" href="#appointment-item{{ $category->id }}" class="tab-block">
                ...
                <div class="tab-content m-b30">
                    @foreach ($categories as $category)
                    <div id="appointment-item{{ $category->id }}" class="pricing-tab-content-block tab-pane {{ $loop->first ? 'active-arrow' : '' }}">
                        <div class="section-content p-t50">
                            <div class="wt-tabs vertical bg-tabs">
                                ...
                                <div class="tab-content p-l50">
                                    @foreach ($category->appointmentServices as $service)
                                    <div id="appointment-tab{{ $service->id }}" class="tab-pane {{ $loop->first ? 'active' : '' }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="wt-tilte">
                                                        ...
                                                        <button wire:click="toggleServiceSelection({{ $service->id }})" class="site-button skew-icon-btn radius-sm">
