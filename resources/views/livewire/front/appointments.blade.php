<div>
	...
	<div class="wt-bnr-inr overlay-wraper"
		style="background-image:url({{ asset('assets/images/banner/gallery-banner.jpg') }});">
		...
		<div class="container">
			...
			<div wire:ignore class="section-content">
				...
				<div class="tab-content m-b30">
					@foreach ($categories as $category)
						<div id="appointment-item{{ $category->id }}"
							class="pricing-tab-content-block tab-pane {{ $loop->first ? 'active-arrow' : '' }} br-10">
										...
										@foreach ($category->appointmentServices as $service)
											<li class="nav-item br-10">
												<a class="nav-link {{ $loop->first ? 'active' : '' }}" data-bs-toggle="tab"
													href="#appointment-tab{{ $service->id }}">
														...
														<div class="col-lg-6 col-md-12">
															<div class="wt-tilte">
																...
																<button wire:click="toggleServiceSelection({{ $service->id }})"
																	class="site-button skew-icon-btn radius-sm br-10">
								...
								@if ($service)
									<div class="col-md-4">
										<div class="service-card">
											...
											<input type="date" wire:model.defer="selectedDateTime.{{ $service->id }}.date" class="form-control"
