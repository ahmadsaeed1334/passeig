...
<div wire:ignore class="section-full bg-gray p-t100 p-b70 bg-repeat" style="background-image:url(../images/background/bg-6.jpg);">
                        ...
                        <div class="wt-media site-text-primary m-b20 radius-bx circle-effect-1 wt-img-overlay11">
                            ...
                            <div class="text-center p-a30 wt-img-overlay11-content text-white">
                                <div class="overlay-11-detail">
                                    <div class="overlay-11-info">
                                        <p class="m-b0">{{Str::limit(strip_tags( $service->description), 100, '...') }}</p>
                                        <h4 class="m-b0"><a href="{{ route('single-service', $service->id) }}">More</a></h4>
                                    </div>
                                </div>
                            ...
                            <div class="price-tag">
                                <div class="price-circle bg-white text-center site-text-primary radius-bx">
                                    <span class="font-18">${{ $service->amount }}</span>
                                </div>
                            </div>
                        </div>
