        ...
        <div class="section-content circle-block-outer" data-bs-toggle="tab-hover">
            <div class="row nav nav-tab">
                ...
                <div class="col-lg-4 col-md-12 m-b30">
                    ...
                    <div class="nav-item">
                        <a class="nav-link @if($key == 0) active @endif wt-icon-box-wraper right p-a10 m-b20" href="#tab{{ $key+1 }}" data-bs-toggle="tab">
                            <div class="icon-md site-text-primary radius">
                                <span class="icon-cell site-text-primary"><img src="{{ asset('storage/' . $health->icon) }}" alt=""></span>
                            </div>
