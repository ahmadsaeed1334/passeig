        ...
        <div class="section-content">
            <div class="row equal-wraper">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    @endphp
                    <div class="blog-post latest-blog-3 overlay-wraper post-overlay date-style-1 bg-cover bg-no-repeat bg-top-center" style="background-image:url({{ Storage::url($featuredBlog->image) }});">
                        ...
                        <div class="wt-post-info p-a30 text-white">
                            <div class="post-overlay-position">
                                <div class="wt-post-title">
                                    <h3 class="post-title"><a href="#" class="text-white text-capitalize">{{ $featuredBlog->title }}</a></h3>
                                    {{-- <h3 class="post-title"><a href="{{ route('blogs.show', $featuredBlog->id) }}" class="text-white text-capitalize">{{ $featuredBlog->title }}</a></h3> --}}
                                </div>
                                <div class="wt-post-meta">
                                    <ul>
                                        <li class="post-date"><i class="fa fa-calendar"></i><strong>{{ $featuredBlog->created_at->format('d M') }}</strong> <span>{{ $featuredBlog->created_at->year }}</span></li>
