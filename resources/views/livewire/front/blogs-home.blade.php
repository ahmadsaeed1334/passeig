        ...
        <div class="section-content">
            <div class="row equal-wraper">
                ...
                <div class="col-lg-6 col-md-12 m-b30">
                    ...
                    <div class="blog-post latest-blog-3 blog-md date-style-1 clearfix">
                        <div class="wt-post-media wt-img-effect zoom-slow br-10">
                            ...
                            <a href="{{ route('single-blog', $blog->id) }}"><img src="{{ Storage::url($blog->image) }}" alt="{{ $blog->title }}"></a>
                        </div>
                        <div class="wt-post-info">
                            <div class="wt-post-title">
                                {{-- <h4 class="post-title font-weight-800"><a href="#">{{ $blog->title }}</a></h4> --}}
                                <h4 class="post-title font-weight-800"><a href="{{ route('single-blog', $blog->id) }}">{{ $blog->title }}</a></h4>
                            </div>
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    @endphp
                    <div class="blog-post latest-blog-3 overlay-wraper post-overlay date-style-1 bg-top-center br-10 zoom-slow bg-cover bg-no-repeat" style="background-image:url({{ Storage::url($featuredBlog->image) }});">
                        ...
                        <div class="wt-post-info p-a30 text-white">
                            <div class="post-overlay-position">
                                <div class="wt-post-title">
                                    ...
                                    <h3 class="post-title"><a href="{{ route('single-blog', $featuredBlog->id) }}" class="text-white text-capitalize">{{ $featuredBlog->title }}</a></h3>
                                </div>
                                <div class="wt-post-meta">
                                    <ul>
                                        <li class="post-date"><i class="fa fa-calendar"></i><strong>{{ $featuredBlog->created_at->format('d M') }}</strong>
                                            <span>{{ $featuredBlog->created_at->year }}</span>
                                        </li>
                                        <li class="post-author"><i class="fa fa-user"></i>By <a href="javascript:;" class="text-white">{{ $featuredBlog->user->name }}</a></li>
                                        <li class="post-comment"><i class="fa fa-comments"></i> <a href="javascript:;" class="text-white">{{ $featuredBlog->comments->count() }} comment(s)</a></li>
                                    </ul>
                                </div>
                                <div class="wt-post-text">
