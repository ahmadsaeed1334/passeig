                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="widget widget_social_inks">
                        ...
                        <ul class="social-icons social-square social-darkest">
                            ...
                            <li class="onHover"><a href="{{ $icon->link }}" target="_blank" class="me-2" style="border-radius: 50px"><i class="fa fa-facebook"></i></a></li>
                            @elseif (strtolower($icon->icon) == 'twitter')
                            <li class="onHover"><a href="{{ $icon->link }}" target="_blank" class="me-2" style="border-radius: 50px"><i class="fa fa-twitter"></i></a></li>
                            @elseif (strtolower($icon->icon) == 'instagram')
                            <li class="onHover"> <a href="{{ $icon->link }}" target="_blank" class="me-2" style="border-radius: 50px"><i class="fa fa-instagram"></i></a></li>
                            @elseif (strtolower($icon->icon) == 'linkedin')
                            <li class="onHover"> <a href="{{ $icon->link }}" target="_blank" class="me-2" style="border-radius: 50px"><i class="fa fa-linkedin"></i></a></li>
                            @elseif (strtolower($icon->icon) == 'youtube')
                            <li class="onHover"><a href="{{ $icon->link }}" target="_blank" class="me-2" style="border-radius: 50px"><i class="fa fa-youtube"></i></a></li>
                            @else
                            <a href="{{ $icon->link }}" target="_blank" class="me-2" style="border-radius: 50px">{{ ucfirst($icon->icon) }}</a>
                            @endif
                            @endforeach
                            @endforeach
                        </ul>
