            ...
            <div class="section-content m-b50">
                <div class="row">
                    ...
                    <div class="wt-box col-md-6">
                        ...
                        @endif
                        <form wire:submit.prevent="submit" class="cons-contact-form p-a30 bg-gray">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 text-right">
                                    <button type="submit" class="site-button m-r15">Submit <i class="fa fa-angle-double-right"></i></button>
                                    <button type="reset" class="site-button">Reset <i class="fa fa-angle-double-right"></i></button>
                                </div>
                            </div>
