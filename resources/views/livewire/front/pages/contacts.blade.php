                ...
                <div class="row">
                    ...
                    <div class="wt-box col-md-6">
                        ...
                        <div class="alert alert-success">
                            <strong><i class="fa fa-thumbs-o-up"></i> Success!</strong>{{ session('success') }}
                        </div>
                        @endif
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12 m-b30">
                                <div class="wt-icon-box-wraper center p-a30 bdr-2 bdr-gray-light h-100 br-10">
                                    <div class="wt-icon-box-sm site-bg-primary m-b20 br-10"><span class="icon-cell text-white"><i class="fa fa-phone"></i></span></div>
                            ...
                            <div class="col-md-4 col-sm-12 m-b30">
                                <div class="wt-icon-box-wraper center p-a30 bdr-2 bdr-gray-light h-100 br-10">
                                    <div class="wt-icon-box-sm site-bg-primary m-b20 br-10"><span class="icon-cell text-white"><i class="fa fa-envelope"></i></span></div>
                                    <div class="icon-content">
                                        <h6>Email</h6>
                                        <p>{{ general('email') }}</p>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-12 m-b30">
                                <div class="wt-icon-box-wraper center p-a30 bdr-2 bdr-gray-light h-100 br-10">
                                    <div class="wt-icon-box-sm site-bg-primary m-b20 br-10"><span class="icon-cell text-white"><i class="fa fa-map-marker"></i></span></div>
                                    <div class="icon-content">
                                        <h5>Address</h5>
                                        <p>{{ general('address') }}</p>
                                    </div>
