(function($){
  ...
  $(window).on('load', function(){
    ...
    $('.contest-details__nav-slider').slick({
      slidesToShow: 5,
      slidesToScroll: 1,
      // asNavFor: '.contest-cart__thumb-slider', // Target only images within contest-details__thumb-slider
      dots: false,
      centerMode: true,
      nextArrow: '<div class="next"><i class="las la-angle-right"></i></div>',
      prevArrow: '<div class="prev"><i class="las la-angle-left"></i></div>',
      ...
      //   slidesToShow: 5, // Number of slides to show on the screen
      //   slidesToScroll: 1, // Number of slides to scroll when you click an arrow
