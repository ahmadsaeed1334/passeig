...
Route::get('/appointments', Appointments::class)->name('appointments');
// Route::get('/appointments', [BookAppointmentController::class, 'index']);
// Route::post('/appointments/select-category', [BookAppointmentController::class, 'selectCategory']);
// Route::post('/appointments/select-sub-category', [BookAppointmentController::class, 'selectSubCategory']);
// Route::post('/appointments/toggle-service-selection', [BookAppointmentController::class, 'toggleServiceSelection']);
// Route::post('/appointments/select-date-time', [BookAppointmentController::class, 'selectDateTime']);
